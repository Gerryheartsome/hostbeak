        ...
        <div className=' lg:w-[340px] h-max bg-[#f9f9f9] py-6'>
            ...
            <div className='mt-6 hidden lg:block'>
                ...
                <div className='flex items-center justify-between p-3 px-9 mx-3 mb-5'>
                    ...
                    <p className='text-base text-[#C4C4C4] pr-14'>Sales</p>
                    <img src={dropArrow} />
                </div>
                ...
                <div className={menu ? 'flex justify-center flex-col py-2 space-y-5  pl-24 mx-4 duration-200':"hidden duration-300"}>
                ...
                <div className='flex items-center justify-between p-3 px-9 mx-3 mb-2'>
                    <img src={Group} onClick={handleClick1} className={menu1 ? 'bg-[#081494] duration-200 scale-150 p-1 py-1 w-[26px] rounded-full': 'w-[26px]'} />
                    <a className='text-base text-[#C4C4C4] cursor-pointer' onClick={handleClick1}>Analytics</a>
                    <img src={dropArrow} onClick={handleClick1} />
                </div>
                <div className={menu1 ? 'flex justify-center flex-col pl-24 space-y-5 mx-4 duration-200':"hidden duration-300"}>
                    <Link to='/viewreport'>
